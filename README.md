...
Note: I've now made version 2.0 the **Latest** version, no longer a pre-release, but it is relatively untested. If you find issues with it feel free to open a ticket (see below). You can fall back to the latest v1.0 version on the release page in case version 2.0.x is giving you issues.
